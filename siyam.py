...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> +9239")
	subprocess.check_output(["am", "start", "https://wa.me/+92319"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://raw.githubusercontent.com/FUCK-king-06/OLD/main/Approval.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[0;96m.##.....##.##.....##.#######.##.....##.########...#######..########
 ...
 > \033[0;92mDEVELOPER     : OliDUR RAHMAN
 > \033[0;95mFACEBOOK ID   : Olidur Rahman 
 > \033[0;41mWHATSAPP      : 0175371*7*9*
 \033[0;96m> YOUTUBE       :  Nai
 > \033[0;97mWARNING       : DONT USE FOR ILLEGAL WORK     
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [FUCK] : %s/%s -> \033[0;92m [ FUCK-OK:%s ]- \033[0;93m[FUCK-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;93m[FUCK-CP😭] %s|%s\033[0;97m         "%(uid, pw))
